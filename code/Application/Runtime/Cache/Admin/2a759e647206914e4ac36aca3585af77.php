	...
	<table class="table table-striped">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody class="file">
			<tr class="template-domeload dade in">
				...
				<td class="delete">	
					<input type="button" value="download"  class="btn yellow cancel" onclick="location.href='/ydlm/admin.php/File/download?filename=<?php echo ($vo["filename"]); ?>'">
					<input type="button" value="Delete"  class="btn red delete" onclick="location.href='/ydlm/admin.php/File/delete?filename=<?php echo ($vo["filename"]); ?>'">
				</td>
			</tr>
