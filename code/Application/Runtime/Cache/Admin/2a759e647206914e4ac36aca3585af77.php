	...
	<table class="table table-striped">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody class="file">
			<tr class="template-domeload dade in">
				...
				<td class="delete">
<!-- 					<input type="button" value="跳转页面" class="btn yellow cancel" onclick="toEx('<?php echo ($vo["pass"]); ?>')">
					<input type="button" value="download"  class="btn yellow cancel" onclick="location.href='/ydlm/Uploads/<?php echo ($vo["path"]); echo ($vo["author"]); ?>.zip'"> -->
...
<!-- 					<form  action="/ydlm/admin.php/File/download?filename=<?php echo ($vo["filename"]); ?>" method="post">
					...
					<input type="submit" value="download"  class="btn yellow cancel" name="download">
					<input type="submit" value="delete"  class="btn yellow cancel" name="delete">
					<input type="submit" value="update"  class="btn yellow cancel" name="update">
<!-- 					<a class="btn red delete" onclick="location.href='/ydlm/admin.php/File/delete?filename=<?php echo ($vo["filename"]); ?>'">Delete</a>
					<a class="btn red delete" onclick="location.href=''">update</a> -->
					</form>
					</form>
