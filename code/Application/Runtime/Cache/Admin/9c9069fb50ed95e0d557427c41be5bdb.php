...
<body class="page-header-fixed">
    ...
    <table class="table table-striped">
        <caption style="font-size:30px">新闻管理</caption>
        <br />
        <thead>
            <tr>
                <th>新闻标题</th>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody class="file">
            <tr class="template-domeload dade in">
                ...
                <td class="delete"> 
                    <input type="button" value="修改"  class="btn yellow cancel" onclick="location.href='/ydlm/admin.php/News/upload?id=<?php echo ($vo["id"]); ?>'">
                    <input type="button" value="删除"  class="btn red delete" onclick="location.href='/ydlm/admin.php/News/delete?id=<?php echo ($vo["id"]); ?>'">
                </td>
            </tr>
    ...
    <form action="/ydlm/admin.php/News/add" enctype="multipart/form-data" method="post">
    ...
    <label class="control-label visible-ie8 visible-ie9">role</label>
        <div class="input-icon left">
            <i class="icon-lock"></i>
            <input class="m-wrap placeholder-no-fix" type="text" name="title" placeholder="新闻标题" required>
            </div>
    </div>
    ...
    <label class="control-label visible-ie8 visible-ie9">role</label>
        <div class="input-icon left">
            <i class="icon-lock"></i>
            <input class="m-wrap placeholder-no-fix" type="text" placeholder="新闻日期" name="date" required>
            </div>
    </div>
    ...
    <label class="control-label visible-ie8 visible-ie9">Password</label>
        <div class="input-icon left">
            <textarea rows="5" cols="20" style="width:232px" name="content"  placeholder="新闻简介" maxlength="100"></textarea>
            </div>
    </div>
