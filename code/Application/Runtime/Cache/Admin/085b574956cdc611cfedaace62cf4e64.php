...
<head>
	...
	<link href="/ydlm/Public/Admin/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
	<link href="/ydlm/Public/Admin/css/daterangepicker.css" rel="stylesheet" type="text/css" />
	<link href="/ydlm/Public/Admin/css/fullcalendar.css" rel="stylesheet" type="text/css"/>
	<link href="/ydlm/Public/Admin/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>
	<link href="/ydlm/Public/Admin/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
...
<body class="page-header-fixed">
	...
	<script src="/ydlm/Public/Admin/js/jquery.vmap.js" type="text/javascript"></script>   

	<script src="/ydlm/Public/Admin/js/jquery.vmap.russia.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.vmap.world.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.vmap.europe.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.vmap.germany.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.vmap.usa.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>  

	<script src="/ydlm/Public/Admin/js/jquery.flot.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.flot.resize.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.pulsate.min.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/date.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/daterangepicker.js" type="text/javascript"></script>     

	<script src="/ydlm/Public/Admin/js/jquery.gritter.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/fullcalendar.min.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.easy-pie-chart.js" type="text/javascript"></script>

	<script src="/ydlm/Public/Admin/js/jquery.sparkline.min.js" type="text/javascript"></script>  
	...
	<script src="/ydlm/Public/Admin/js/index.js" type="text/javascript"></script>        
